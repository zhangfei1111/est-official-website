...
var Fixture = class {
  ...
  async installNpmDependencies() {
    ...
    const packageJSONPath = (0, import_node_path2.join)(this.directory.path, "package.json");
  ...
  async deleteFile(path5) {
    ...
    const filePath = (0, import_node_path2.join)(this.directory.path, path5);
    try {
  ...
  withFile(path5, contents) {
    this.files.push({ contents, path: path5 });
    return this;
  }
