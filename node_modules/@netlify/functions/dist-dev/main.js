...
var NetlifyFunction = class {
  ...
  async invoke(request, clientContext) {
    await this.buildQueue;
    if (this.buildError) {
...
var getTargetDirectory = async (projectRoot) => {
...
var lambdaEventFromWebRequest = async (request) => {
...
var FunctionsHandler = class {
  ...
  async match(request) {
    ...
    return {
      handle: (request2) => this.invoke(request2, func),
