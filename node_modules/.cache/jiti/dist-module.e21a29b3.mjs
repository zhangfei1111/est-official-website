...
const _module = exports.default = (0, _kit.defineNuxtModule)({
  ...
  setup(options, nuxt) {
    ...
    const { resolve } = (0, _kit.createResolver)("file:///Users/zhangfei/workspace/chengchu-website/node_modules/nuxt-echarts/dist/module.mjs");
    ...
    const rendererNames = [];
    renderers.forEach((v) => {
      if (v === "canvas") rendererNames.push("CanvasRenderer");else
      if (v === "svg") rendererNames.push("SVGRenderer");
    });
    ...
    "UPDATE_OPTIONS_KEY",
    "LOADING_OPTIONS_KEY"].
    forEach((name) => (0, _kit.addImports)({ name, from: "vue-echarts" }));
  }
}); /* v9-d070ed51cf5df4ec */
