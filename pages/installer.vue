<template>
  <div class="installer">
    <div class="installer-pc only-desktop">
      <section class="installer-header">
        ...
        <div class="installer-scroll">
          Scroll to see more
          <img class="installer-scroll-icon" src="../assets/image/home-introduce-scroll.webp" alt="" />
        </div>
      </section>
